...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2021 a las 03:57:36
...
INSERT INTO `cliente` (`IdCliente`, `Dni`, `Nombres`, `Direccion`, `Departamento`) VALUES
(17, '2', 'Juan Guerrero Solis', 'Los Alamos', '1'),
(18, '1', 'Maria Rosas Villanueva', 'Los Laureles 234', 'Cochabamba'),
(19, '3', 'Andres de Santa Cruz', 'Av. La Frontera 347', 'Oruro'),
(20, '4', 'Andres Mendoza', 'Chosica, Lurigancho', 'La Paz'),
(22, '452', 'roque', 'palmeras', 'oruro'),
(27, '660', 'otto to', 'los pinos', 'la paz');
...
INSERT INTO `empleado` (`IdEmpleado`, `Dni`, `Nombres`, `Telefono`, `Departamento`, `User`) VALUES
(1, '123', 'Pedro Hernandez', '988252459', 'Santa Cruz', 'emp01'),
(2, '123', 'Roman Riquelme', '988252459', 'La Paz', 'Jo46'),
(4, '420', 'Ronald Flores', '72569842', 'Pando', 'nald24'),
(6, '850', 'Tony Montana', '74296321', 'Cochabamba', 'mon40'),
(7, '750', 'Boby Comunista', '78541230', 'Oruro', 'boby1'),
(8, '420', 'Ronald Flores', '72569842', 'Pando', 'nald24');
...
INSERT INTO `producto` (`IdProducto`, `Nombres`, `Precio`, `Stock`, `Departamento`) VALUES
(1, 'Teclado Logitech 345 Editado', 150, 99, 'Potosi'),
(2, 'Mouse Logitech 567', 20, 98, 'Oruro'),
(3, 'Laptop Lenovo Ideapad 520', 800, 100, 'La Paz'),
(4, 'HeadPhones Sony M333', 500, 98, 'La Paz'),
(7, 'Producto Nuevo w', 22, 35, 'Oruro'),
(8, 'audifonos PSS', 55, 4, 'La Paz'),
(9, 'audifonos PSS', 28, 4, 'La Paz'),
(10, 'cable utp', 0, 60, 'La Paz'),
(12, 'pantalla LED DELL', 950, 6, 'La Paz');
