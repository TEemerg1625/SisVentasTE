            ...
            <div class="card-body col-ms-6">
                <form action="Controlador?menu=Producto" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="${producto.getDepto()}" name="txtdepartamento" class="form-control">
                    </div>
                ...
                <tbody>
                    <c:forEach var="pro" items="${productos}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="Controlador?menu=Producto&accion=Delete&id=${pro.getIdProducto()}" >Delete</a>
                        </td>
                    </tr>
